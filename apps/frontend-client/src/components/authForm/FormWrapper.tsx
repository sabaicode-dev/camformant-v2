...
export function FormWrapper({ children , title , description }: SignUpFormWrapperProps) {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-8 dark:bg-[#181f39]">
      <div className="flex flex-col-reverse md:flex-row w-full md:w-3/4 lg:w-2/3 bg-gray-100 rounded-lg shadow-lg overflow-hidden dark:bg-[#1e2746]">
