...
// import ChatProfile from "@/components/user-chat";
// import ProfileChat from "@/components/chat-detail";
...
//         </div>
//         <div className="w-full overflow-y-scroll scrollbar-custom px-2">
//         </div> */}
...
//         <div className="w-full px-7 flex-grow overflow-y-scroll scrollbar-custom ">
//           <ProfileChat
//             message="hello"
//             profileImage="https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
//           />
//         </div>
//         <div className="sticky flex gap-[20px] items-center h-[40px] justify-center mt-auto ">
